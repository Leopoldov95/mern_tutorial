...
import {Avatar, Button, Paper, Grid, Typography, TextField, Container} from '@material-ui/core';
                    ...
                    <Grid container justify="flex-end">
                        <Grid item>
                            <Button onClick={switchMode}>
                                {isSignup ? 'Already hanve an account? Sign In' : 'Don\'t have an account? Sign up' }
                            </Button>
                        </Grid>
                    </Grid>
                </form>
